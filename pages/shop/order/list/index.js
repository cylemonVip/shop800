...
Page({
    ...
    group_show:function(e){
      ...
      _function.getUserOrderList(wx.getStorageSync("utoken"), that.data.this_page, that.data.group_val, that.initUserOrderListData, this)
      setTimeout(() => {
    ...
    initdeleteOrderInfoData:function(data){
        ...
        if(data.code == 1){
            ...
            _function.getUserOrderList(wx.getStorageSync("utoken"), that.data.this_page, that.data.group_val,that.initUserOrderListData,that)
        }else if(data.code == 2){
            wx.showToast({
                title: '登陆中',
                icon: 'loading',
    ...
    indexscrolltolower:function(){
      ...
      if(that.data.this_finish_page != that.data.this_page){
        _function.getUserOrderList(wx.getStorageSync("utoken"), that.data.this_page + 1, that.data.group_val,that.initUserOrderListLoadData,this)
      }
    },
